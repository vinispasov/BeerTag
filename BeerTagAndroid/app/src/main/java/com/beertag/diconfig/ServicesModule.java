...
import com.beertag.services.HttpRatingsService;
...
public class ServicesModule {
    ...
    @Provides
    public RatingsService ratingsService(RatingsRepository repository) {
        return new HttpRatingsService(repository);
    }
}
